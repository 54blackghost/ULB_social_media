    ...
    <div className='min-h-screen bg-gradient-to-b from-slate-50 to-white'>
        <div className="max-w-6xl mx-auto p-6">
          ...
          <div className="mb-8">
            ...
            <p className="text-slate-600">Share your thughts with the world</p>
          </div>
          ...
          <div className="max-w-xl bg-white p-4 sm:p-8 sm:pb-3 rounded xl shadow-md space-y-4">
            ...
            placeholder:text-black" placeholder="What's happening?" value={content} 
              ...
              images.length > 0 && <div>
                {images.map((image, i)=>(
                  <div key={i} className="relative group">
                    ...
                    !== i))} className="absolute hidden group-hover:flex justify-center items-centr 
            ...
            {/* Bottom Bar */}
             <div className="flex items-center justify-between pt-3 border-t border-gray-300">
              ...
              hover:to-purple-700 active:scale-95 transition text-white font-medium px-8 py-2 rounded-md 
              cursor-pointer">
                   Publish Post
              </button>
             </div>
